            ...
            <div key={car.id} className="col-md-4 mb-10" style={{ padding: '10px' }}>
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <button className="btn btn-success btn-sm"style={buttonSpacing} onClick={()=>updateCar(car)} >Edit</button>
                 
                  <button className="btn btn-danger btn-sm" onClick={()=>deleteCar(car)}>Delete</button>
                </div>
              </div>
            </div>
          ))}
